...
int LivroBusca( ListaLivro*, int* ); // Funcao que busca um livro e retorna um ponteiro para o mesmo
...
int AlunoBusca( ListaAluno*, int* ); // Funcao que busca um aluno e retorna um ponteiro para o mesmo
